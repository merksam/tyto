...
panel() { "$TMP/compose" "$TMP/$1-crop.png" "$OUT/$1.png" "$2" "${3:-}"; }
...
scene 01-capture
panel 01-capture "Press ⌘⇧9. The screen freezes instantly." \
...
scene 02-annotate
panel 02-annotate "Mark it up without leaving the capture." \
...
scene 04-steps
panel 04-steps "Number the steps." \
